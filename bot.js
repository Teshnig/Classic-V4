...
//settings
global.owner = ['258869103969'] //owner number +258869103969
global.wame = ['+258869103969'] 
global.pemilik = ['+258869103969'] //owner number ++447441437150
global.premium = ['+258869103969'] //premium number +258869103969
global.pengguna = 'King Sam' //username
global.footer = 'CLASSIC BOT'
global.botnma = 'CLASSIC BOT' //bot name
global.botname = 'CLASSIC-V4'
global.ownernma = 'King Sam' //owner name
global.packname = '⫹⸙⧉𝐂𝐋𝐀𝐒𝐒𝐈𝐂-𝐕4⧉⸙⫺' //sticker package name
global.author = '༺֎ᚏ༈࿉𝐀𝐍𝐎𝐍𝐘𝐌𝐎𝐔𝐒⧉ᚙ֎⸙༻' //sticker author name
global.sessionName = 'Classic_Session' //session name
global.prefa = ['#','!','/',''] //prefix
global.sp = '🔵' //sp
...
global.limittot = 100,
global.thumb = fs.readFileSync('./Classicbot/drips.jpg')
global.reactmoji = '🇿🇼'
...
global.mess = {
    ...
    botAdmin: '*Classic bot  must be admin first!*',
    owner: '*this feature is only for Classic owner*',
    group: '*Feature is only for groups!*',
    grouponly: '*Group Mode Only*',
    private: 'Features Used Only For Private Chat!',
    bot: 'This feature in only for the bot number',
    wait: '*whoa wait a moment Classic proccessing*',
